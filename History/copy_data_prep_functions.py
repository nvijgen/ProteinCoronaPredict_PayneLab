...
#     fold_idx = range(len(pearson_scores))
#     axs[0].plot(fold_idx, pearson_scores, 'bo', label='Pearson', color='black', marker='o')
#     axs[0].plot(fold_idx, r2_scores, 'go', label='R2', color='grey', marker='s')
#     axs[0].plot(fold_idx, mse, 'kx', label='MSE', color='darkgrey', marker='x')
#     axs[0].plot(fold_idx, spear, 'ro', label='Spearman', color='lightgrey', marker='^')
#     axs[0].legend()
#     axs[0].set_title('Individual Scores\n{}'.format(identifier))
#     axs[0].set_xlabel('Fold Index')
#     axs[0].set_ylabel('Score')

#     # Plot average and standard deviation of the scores
#     metrics = ['Pearson', 'R2', 'MSE', 'Spearman']
#     means = [pearson_mean, r2_mean, mse_mean, spear_mean]
#     stds = [pearson_std, r2_std, mse_std, spear_std]
#     colors = ['black', 'grey', 'darkgrey', 'lightgrey']
#     axs[1].bar(metrics, means, yerr=stds, capsize=5, color=colors)
#     axs[1].set_title('Average and Standard Deviation of Scores')
#     axs[1].set_ylabel('Score')
...
#     # Plot individual scores for each fold
#     fold_idx = range(len(pearson_scores))
#     axs[0].plot(fold_idx, pearson_scores, 'o', label='Pearson', color='black', markersize=4)
#     axs[0].plot(fold_idx, r2_scores, 's', label='R2', color='grey', markersize=4)
#     axs[0].plot(fold_idx, spear, '^', label='Spearman', color='lightgrey', markersize=4)
#     axs[0].legend()
...
#     bars = axs[1].bar(metrics, means, yerr=stds, capsize=5, color=colors)
#     axs[1].set_title('Average and Standard Deviation of Scores', fontweight='bold', color='black')
...
#     # Plot individual scores for each fold
#     fold_idx = range(len(pearson_scores))
#     axs[0].plot(fold_idx, pearson_scores, 'o', color='black', markersize=4)
#     axs[0].plot(fold_idx, r2_scores, 's', color='grey', markersize=4)
#     axs[0].plot(fold_idx, spear, '^', color='lightgrey', markersize=4)

#     # Manually create the legend to ensure no duplicates
#     axs[0].legend(['Pearson', 'R2', 'Spearman'], loc='upper left')
